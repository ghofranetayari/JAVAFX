...
public class SignController implements Initializable {
   ...
   role=luser.get(0).getRole().name() ;
     if  (email.equals("user@gmail.com") && password.equals("123456789q")) {
            ...
            FXMLLoader adminLoader = new FXMLLoader(getClass().getResource("espaceAdmin.fxml"));
            ...
            FXMLLoader clientLoader = new FXMLLoader(getClass().getResource("Guide.fxml"));
            Parent clientRoot = clientLoader.load();
             GuideController r = clientLoader.getController();
            r.chargerEvenements(u);
            femail.getScene().setRoot(clientRoot);
        }
        else if (role.equals("CLIENT")){
          FXMLLoader clientLoader = new FXMLLoader(getClass().getResource("RechercheWindow.fxml"));
            Parent clientRoot = clientLoader.load();
           RechercheWindowController r = clientLoader.getController();
