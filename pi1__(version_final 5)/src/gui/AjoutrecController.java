...
public class AjoutrecController implements Initializable {
    ReclamationCRUD  r5 = new ReclamationCRUD ();
     private int  ah;
    public void takeid(int ah){
    this.ah=ah;
        System.out.println("ff"+ah);
    }

    private String mode = "add"; // Initialize with "add" mode
    ...
    private void saveReclamation(ActionEvent event) {
        ...
        int clientId = ah;
        System.out.println("jaw"+clientId);  

// mbaad nbadlou bel id shih
        ...
        showErrorDialog("Erreur "," Tous les champs doivent être remplis, et la date doit être sélectionnée.");
            ...
            if (result.isPresent() && result.get() == okButton) {
                ...
                reclamation r3 = new reclamation(ah, textReclamation, cibleReclamation, EtatReclamation, dateReclamation);
