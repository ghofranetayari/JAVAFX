...
public class SsController implements Initializable {
    private int  ach;
    public void takeid300(int ah){
    this.ach=ah;
        System.out.println("achref"+ah);
    } 
    ...
    CarteFidelite f1 = CarteFideliteCrud.getCarteFideliteByIdU(25);
    CarteFideliteCrud g = new CarteFideliteCrud();
    
        //CarteFidelite f1 = CarteFideliteCrud.getCarteFideliteByIdU(5); 
             private int ptsFidelite = f1.getPtsFidelite(); 
              NiveauCarte niveau = NiveauCarte.valueOf("silver");


    @Override
    public void initialize(URL url, ResourceBundle rb) {
     /*   
       f1= g.getCarteFideliteById(1);
      int ptsFidelite = f1.getPtsFidelite(); 
      
         NiveauCarte niveau =f1.getNiveauCarte();
        */
                ...
                public void handle(ActionEvent event) {
                    ...
                    if (result == ButtonType.OK) {
                        if (ptsFidelite >= 1000 && niveau != NiveauCarte.gold) {
                           ...
                           CarteFideliteCrud connection = new CarteFideliteCrud(); 
                           connection.UpgradeCarte1(5);
                        }
                    }
                }
            }); 
