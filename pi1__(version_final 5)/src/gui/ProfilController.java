...
public class ProfilController implements Initializable {
     ...
     @FXML
    private Label t3a9rib;
    
    public int  ah;
    
    public void takeid10(int ah){
    this.ah=ah;
    
    t3a9rib.setText(String.valueOf(ah));
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        System.out.println("ektb taayari"+this.ah);
        affichage();
    ...
    public void affichage() {
        ...
        data = FXCollections.observableArrayList(serviceuser.rechercherNotTousLesUtilisateurs(25));
    ...
    private void Logout(ActionEvent event) {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("RechercheWindow.fxml"));
            try {
